...
/**
 * Test for the {@link MarsagliaTsangWangDiscreteSampler102}. The tests hit edge cases for
 * the sampler.
 */
public class MarsagliaTsangWangDiscreteSampler102Test {
     ...
     * @return the sampler
     */
    private static MarsagliaTsangWangDiscreteSampler102 createSampler(final int[] probabilities, int offset) {
        final UniformRandomProvider rng = new SplitMix64(0L);
        return new MarsagliaTsangWangDiscreteSampler102(rng, probabilities, offset);
    }
     ...
     * @return the sampler
     */
    private static MarsagliaTsangWangDiscreteSampler102 createSampler(double[] probabilities) {
        final UniformRandomProvider rng = new SplitMix64(0L);
        return new MarsagliaTsangWangDiscreteSampler102(rng, probabilities);
    }
    ...
    public void testOffsetSamples() {
        ...
        final MarsagliaTsangWangDiscreteSampler102 sampler1 = new MarsagliaTsangWangDiscreteSampler102(rng1, prob, offset1);
        final MarsagliaTsangWangDiscreteSampler102 sampler2 = new MarsagliaTsangWangDiscreteSampler102(rng2, prob, offset2);
        final MarsagliaTsangWangDiscreteSampler102 sampler3 = new MarsagliaTsangWangDiscreteSampler102(rng3, prob, offset3);
    ...
    public void testRealProbabilityDistributionSamples() {
        ...
        final MarsagliaTsangWangDiscreteSampler102 dummySampler = new MarsagliaTsangWangDiscreteSampler102(dummyRng, probabilities);
        // This will throw if the table is incomplete as it hits the upper limit
        dummySampler.sample();

        // Do a test of the actual sampler
        final MarsagliaTsangWangDiscreteSampler102 sampler = new MarsagliaTsangWangDiscreteSampler102(rng, probabilities);
