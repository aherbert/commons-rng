...
/**
 * Test for the {@link MarsagliaTsangWangDiscreteSampler2}. The tests hit edge cases for
 * the sampler.
 */
public class MarsagliaTsangWangDiscreteSampler2Test {
     ...
     * @return the sampler
     */
    private static MarsagliaTsangWangDiscreteSampler2 createSampler(final int[] probabilities, int offset) {
        final UniformRandomProvider rng = new SplitMix64(0L);
        return new MarsagliaTsangWangDiscreteSampler2(rng, probabilities, offset);
    }
     ...
     * @return the sampler
     */
    private static MarsagliaTsangWangDiscreteSampler2 createSampler(double[] probabilities) {
        final UniformRandomProvider rng = new SplitMix64(0L);
        return new MarsagliaTsangWangDiscreteSampler2(rng, probabilities);
    }
    ...
    public void testOffsetSamples() {
        ...
        final MarsagliaTsangWangDiscreteSampler2 sampler1 = new MarsagliaTsangWangDiscreteSampler2(rng1, prob, offset1);
        final MarsagliaTsangWangDiscreteSampler2 sampler2 = new MarsagliaTsangWangDiscreteSampler2(rng2, prob, offset2);
        final MarsagliaTsangWangDiscreteSampler2 sampler3 = new MarsagliaTsangWangDiscreteSampler2(rng3, prob, offset3);
    ...
    public void testRealProbabilityDistributionSamples() {
        ...
        final MarsagliaTsangWangDiscreteSampler2 dummySampler = new MarsagliaTsangWangDiscreteSampler2(dummyRng, probabilities);
        // This will throw if the table is incomplete as it hits the upper limit
        dummySampler.sample();

        // Do a test of the actual sampler
        final MarsagliaTsangWangDiscreteSampler2 sampler = new MarsagliaTsangWangDiscreteSampler2(rng, probabilities);
