...
public final class ArraySampler {
     ...
     * inequalities is true: <ul> <li>{@code fromIndex < 0}
     * <li>{@code fromIndex > toIndex} <li>{@code toIndex > length}
     * <li>{@code length < 0}, which is implied from the former inequalities </ul>
     *
