 ...
 * 11, Issue 3</a>
 */
public class MarsagliaTsangWangDiscreteSamplerBase10Byte implements DiscreteSampler {
     ...
     */
    MarsagliaTsangWangDiscreteSamplerBase10Byte(UniformRandomProvider rng,
                                      int[] prob,
                                      int offset) {
        if (offset < 0) {
     ...
     */
    public MarsagliaTsangWangDiscreteSamplerBase10Byte(UniformRandomProvider rng,
