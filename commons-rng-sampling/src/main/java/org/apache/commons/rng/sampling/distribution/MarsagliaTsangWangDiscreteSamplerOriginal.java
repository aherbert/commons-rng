 ...
 * 11, Issue 3</a>
 */
public class MarsagliaTsangWangDiscreteSamplerOriginal implements DiscreteSampler {
     ...
     */
    MarsagliaTsangWangDiscreteSamplerOriginal(UniformRandomProvider rng,
                                      int[] prob,
                                      int offset) {
        if (offset < 0) {
     ...
     */
    public MarsagliaTsangWangDiscreteSamplerOriginal(UniformRandomProvider rng,
