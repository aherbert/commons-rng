 ...
 * 11, Issue 3</a>
 */
public class MarsagliaTsangWangDiscreteSamplerByte2D implements DiscreteSampler {
     ...
     */
    MarsagliaTsangWangDiscreteSamplerByte2D(UniformRandomProvider rng,
                                      int[] prob,
                                      int offset) {
        if (offset < 0) {
     ...
     */
    public MarsagliaTsangWangDiscreteSamplerByte2D(UniformRandomProvider rng,
