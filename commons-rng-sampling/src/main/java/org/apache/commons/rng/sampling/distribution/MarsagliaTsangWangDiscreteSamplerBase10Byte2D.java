 ...
 * 11, Issue 3</a>
 */
public class MarsagliaTsangWangDiscreteSamplerBase10Byte2D implements DiscreteSampler {
     ...
     */
    MarsagliaTsangWangDiscreteSamplerBase10Byte2D(UniformRandomProvider rng,
                                      int[] prob,
                                      int offset) {
        if (offset < 0) {
     ...
     */
    public MarsagliaTsangWangDiscreteSamplerBase10Byte2D(UniformRandomProvider rng,
