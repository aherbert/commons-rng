 ...
 * 11, Issue 3</a>
 */
public class MarsagliaTsangWangDiscreteSampler10 implements DiscreteSampler {
     ...
     */
    MarsagliaTsangWangDiscreteSampler10(UniformRandomProvider rng,
                                      int[] prob,
                                      int offset) {
        if (offset < 0) {
     ...
     */
    public MarsagliaTsangWangDiscreteSampler10(UniformRandomProvider rng,
