 ...
 * 11, Issue 3</a>
 */
public class MarsagliaTsangWangDiscreteSamplerBase10Short2D implements DiscreteSampler {
     ...
     */
    MarsagliaTsangWangDiscreteSamplerBase10Short2D(UniformRandomProvider rng,
                                      int[] prob,
                                      int offset) {
        if (offset < 0) {
     ...
     */
    public MarsagliaTsangWangDiscreteSamplerBase10Short2D(UniformRandomProvider rng,
