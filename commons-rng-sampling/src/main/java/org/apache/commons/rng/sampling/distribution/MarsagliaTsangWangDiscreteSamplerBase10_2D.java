 ...
 * 11, Issue 3</a>
 */
public class MarsagliaTsangWangDiscreteSamplerBase10_2D implements DiscreteSampler {
     ...
     */
    MarsagliaTsangWangDiscreteSamplerBase10_2D(UniformRandomProvider rng,
                                      int[] prob,
                                      int offset) {
        if (offset < 0) {
     ...
     */
    public MarsagliaTsangWangDiscreteSamplerBase10_2D(UniformRandomProvider rng,
