 ...
 * 11, Issue 3</a>
 */
public class MarsagliaTsangWangDiscreteSamplerShort implements DiscreteSampler {
     ...
     */
    MarsagliaTsangWangDiscreteSamplerShort(UniformRandomProvider rng,
                                      int[] prob,
                                      int offset) {
        if (offset < 0) {
     ...
     */
    public MarsagliaTsangWangDiscreteSamplerShort(UniformRandomProvider rng,
