 ...
 * 11, Issue 3</a>
 */
public class MarsagliaTsangWangDiscreteSampler2D implements DiscreteSampler {
     ...
     */
    MarsagliaTsangWangDiscreteSampler2D(UniformRandomProvider rng,
                                      int[] prob,
                                      int offset) {
        if (offset < 0) {
     ...
     */
    public MarsagliaTsangWangDiscreteSampler2D(UniformRandomProvider rng,
