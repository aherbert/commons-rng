...
public class GenerationPerformance2 {
    /**
     * RNG providers.
     */
//    @Param({
...
//            })
    ...
    static class Int0 extends IntProvider {
        @Override
        public int next() {
            return 0;
        }
    ...
    static class IntCounter extends IntProvider {
        int state;
    ...
    static class IntCounterShift extends IntProvider {
        int state;
...
//        })
    ...
    @Benchmark
    public void nextInt1(Sources sources) {
